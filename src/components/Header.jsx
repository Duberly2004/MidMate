    ...
    <header class="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
      ...
      >
        <div class="flex items-center justify-between">
          {/* <!-- Logo --> */}
          <a
            class="flex text-white rounded-md text-xl font-semibold focus:outline-none focus:opacity-80"
            href="/"
            aria-label="Preline"
          >
        ...
        >
          <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
            ...
            <div>
              <a
                class="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#7ecef4] font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
                href="/chat"
              >
                Chat
              </a>
